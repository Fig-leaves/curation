...
class CardListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, AdstirMraidViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        articles = Request.fetchFromCardList(Constants.card_list.URL, items: articles)
