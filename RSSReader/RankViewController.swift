...
class RankViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, AdstirMraidViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        TrackingManager.sendScreenTracking("IOS")
    ...
    func fetchData(items:NSMutableArray) -> NSMutableArray {
        var today = NSDate()
        var month_ago = NSDate()
        ...
        for(var i = 0; i < 30 ; i++) {
            ...
            let str:String = formatter.stringFromDate(month_ago)
            content["title"] = str;
            content["link"] = "http://appdb.jp/jp/?date=" + str + "2015-12-07&type=topsales&genre=all"
