...
class Chara2ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, MWFeedParserDelegate, AdstirMraidViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Hard"
        TrackingManager.sendScreenTracking("Hard")
        
        articles = Request.fetchFromChara(Constants.chara.chara2, items: articles)
