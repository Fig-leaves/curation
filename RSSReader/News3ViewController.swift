...
class News3ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, AdstirMraidViewDelegate  {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        TrackingManager.sendScreenTracking("IOSトピック")
    ...
    func tableView(table: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        TrackingManager.sendEventTracking("IOSトピック", action:"Push", label:"閲覧", value:NSNumber(), screen:"IOSトピック")
        click_count++;
